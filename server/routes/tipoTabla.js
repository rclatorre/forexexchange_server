...
//Inicializar tablas
app.post('/tipoTablaInit/:id', [verificaToken, verificaAdmin_Role], (req, res) => {
    let id = req.params.id;

    if (id !== 'pcsSpcl2020') return;

    var tipoTablas = [{
            "codigo": "TipoDocumentoIdentidad",
        ...
        {
            "codigo": "EstadoDeTransaccion",
            "descripcion": "Estado de Transaccion"
        },
        {
            "codigo": "CiudadEstablecimiento",
            "descripcion": "Ciudades de Establecimientos"
        },
        {
            "codigo": "OpcionesDeEntrega",
            "descripcion": "Opciones de Entrega"
        },
        {
            "codigo": "Bancos",
            "descripcion": "Bancos"
        ...
        {
            "codigo": "DestinoTransaccion",
            "descripcion": "Destino de la Transaccion"
        },
        {
            "codigo": "TipoPropiedadCuenta",
            "descripcion": "Tipo de Propiedad de Cuenta Bancaria"
        }
    ];

    TipoTabla.insertMany(tipoTablas, function(err, tipoTablaDB) {
        if (err) {
            // 400 bad request
            return res.status(500).json({
                ok: false,
