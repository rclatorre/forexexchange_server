...
var configuracionSchema = new Schema({
    ...
    nombreComercial: { type: String, required: [true, 'El nombre comercial es necesaria'] },
    urlPlataforma: { type: String, required: [true, 'La url de la plataforma es necesaria'] },
    ...
    textosVariables: {
        ...
        bancosProvincia: { type: String, required: [true, 'El datos bancos provincia es necesario'] },
